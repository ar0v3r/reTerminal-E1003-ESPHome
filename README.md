...
The primary motivation for publishing this project is to document deep sleep power optimizations that dramatically extend battery life. Out of the box, a stock ESPHome setup on this device draws ~185mA during the awake idle state and 4–5mA during deep sleep — resulting in a real-world battery life of roughly 20–30 days. Through iterative testing, the deep sleep current was reduced to below the detection limit of a BM235 multimeter, with the goal of approaching Seeed's advertised upper limit of 6 months (potentially more, depending on your update interval).
