...
This project was built with inspiration from several community projects (credited below) and optimized through active testing with Claude (Anthropic's AI assistant). If you prefer not to use AI-assisted code, the key power-related findings are documented in the [Power](#power) section below and can be adopted independently into any ESPHome configuration for this device.
